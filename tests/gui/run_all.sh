...
for t in test_phase4a test_grid_replay test_plan_form test_right_scene \
         ...
         test_depth17 test_save_pool test_frame_table test_c5_consumers test_trim_axis test_convert_frames test_capture_all test_write_axes test_new_scene_version \
