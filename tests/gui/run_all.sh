...
for t in test_phase4a test_grid_replay test_plan_form test_right_scene \
         ...
         test_depth17 test_save_pool test_frame_table test_c5_consumers test_trim_axis test_convert_frames test_capture_all test_write_axes test_new_scene_version test_trim_time test_rate_decoupled test_reset_slot \
         ...
         test_station_save test_wheel_guard test_waypoint_kinematics test_home_blend \
         ...
         test_trim_controls test_plot_widgets test_jobs test_upload_dialogs test_provenance test_proxy_dialog test_repack test_convert_fps; do
