...
- Two checkouts, one desktop icon each (2026-09-10):
  ...
  shows an empty collector leaderboard while 65 sessions sit in the other file
  (2026-09-13). Anything else state-dir-scoped that describes the *dataset, the
  Hub, or the operators* belongs on that list too. **The dataset root is a setting, not an
